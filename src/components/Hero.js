...
const Hero = () => {
  return (
    ...
    <div className='font-bold pt-28 md:pt-5 p-5 flex font-dancing flex-col text-center md:flex-row lg:text-8xl md:text-7xl sm:text-6xl  text-5xl space-y-5 md:space-y-0 mx-auto'>
